...
static void ruy_st(benchmark::State& state, const char* net)
{
  ...
  static void qs8_gemm_2x8__neon_mull_padal_dup(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_2x8__neon_mull_padal_dup, 2, 8, 1, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_3x8__neon_mull_padal_dup(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_3x8__neon_mull_padal_dup, 3, 8, 1, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_4x8__neon_mull_padal_dup(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_4x8__neon_mull_padal_dup, 4, 8, 1, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_2x16__neon_mull_padal_dup(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_2x16__neon_mull_padal_dup, 2, 16, 1, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_3x16__neon_mull_padal_dup(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_3x16__neon_mull_padal_dup, 3, 16, 1, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_4x16__neon_mull_padal_dup(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_4x16__neon_mull_padal_dup, 4, 16, 1, 1, benchmark::utils::CheckNEON);
  }
  ...
  BENCHMARK_GEMM(qs8_gemm_2x8__neon_mull_padal_dup)
  BENCHMARK_GEMM(qs8_gemm_3x8__neon_mull_padal_dup)
  BENCHMARK_GEMM(qs8_gemm_4x8__neon_mull_padal_dup)
  BENCHMARK_GEMM(qs8_gemm_2x16__neon_mull_padal_dup)
  BENCHMARK_GEMM(qs8_gemm_3x16__neon_mull_padal_dup)
  BENCHMARK_GEMM(qs8_gemm_4x16__neon_mull_padal_dup)
